...
<div id="login" className="signin-card loginstyle">
  ...
  <h1 className="display1 logintextcolor">Freelancer-Signup</h1>
  ...
  <option value="female">female</option>
    ...
    <div id="form-login-username" className="form-group">
    <label for="city" className="float-label logintextcolor" >City</label>
  ...
  {/* //////////Add TUnisian citys///// */}
    ...
    <div id="form-login-username" className="form-group">
    <label for="field" className="float-label logintextcolor" >field</label>
